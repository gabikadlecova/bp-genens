...
%
% HYPOTHESIS! will be needed later in the text
%
...
to achieve better results. % Here I'll mention some applications...
...
\textbf{Variant A, possibly inacurrate}
...
%\textbf{Variant B, possibly tedious to read}
%The computational learning theory defines the term \emph{learnability},
