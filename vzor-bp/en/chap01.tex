...
learning. We will focus on supervised learning and on classification in
particular.

\subsection{Performance of machine learning models}
In this section we describe the general terms related to evaluation and
performance estimation of machine learning models. We first present a formal 
...
ensembles. % cite sklearn? for the pipeline
...
feature extraction and feature selection. % Should I describe this more?
