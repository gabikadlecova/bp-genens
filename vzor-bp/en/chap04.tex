...
method on \emph{madelon}.

The datasets which were problematic for our system were notably the
jungle\_chess\_2pcs\_raw\_endgame\_complete dataset (jungle\_chess for short),
and CIFAR-10. The jungle\_chess dataset is associated with only
